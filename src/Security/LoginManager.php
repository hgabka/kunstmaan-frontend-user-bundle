...
class LoginManager implements LoginManagerInterface
{
     ...
     * {@inheritdoc}
     */
    final public function logInUser($firewallName, KunstmaanFrontendUserInterface $user, Response $response = null)
    {
     ...
     */
    protected function createToken($firewall, KunstmaanFrontendUserInterface $user)
    {
